...
const reqs = [
  ...
  { jsonrpc: "2.0", id: 2, method: "tools/call", params: { name: "dsh_inspect", arguments: {} } },
  {
    ...
    id: 3,
    method: "tools/call",
    params: { name: "dsh_run", arguments: { task: "say OK in one word", timeoutMs: 15000 } },
  },
  {
    jsonrpc: "2.0",
    id: 4,
    ...
    params: {
      ...
      arguments: { instances: [{ label: "x1" }, { label: "x2" }], routing: "least-loaded" },
    },
  },
  {
    jsonrpc: "2.0",
    id: 5,
    method: "tools/call",
    params: { name: "dsh_cluster_route", arguments: { clusterId: "FROM_4", task: "say hello", timeoutMs: 15000 } },
  },
];
        ...
        if (data.ok && data.data?.clusterId) {
          ...
          child.stdin.write(
            JSON.stringify({
              ...
              method: "tools/call",
              params: {
                name: "dsh_cluster_route",
                arguments: { clusterId: cid, task: "say routed", timeoutMs: 15000 },
              },
            }) + "\n",
          );
        }
...
for (const id of [1, 2, 3, 4, 5]) {
  ...
  if (!r) {
    console.log("id " + id + ": (no response)");
    continue;
  }
  if (r.error) {
    console.log("id " + id + ": ERROR " + JSON.stringify(r.error).slice(0, 200));
    continue;
  }
