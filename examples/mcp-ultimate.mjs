...
send({
  ...
  id: 1,
  method: "initialize",
  params: { protocolVersion: "2024-11-05", capabilities: {}, clientInfo: { name: "ult", version: "0.1" } },
});
...
const cid = JSON.parse(
  cr.result.structuredContent.data ? JSON.stringify(cr.result.structuredContent.data) : cr.result.content[0].text,
).clusterId;
